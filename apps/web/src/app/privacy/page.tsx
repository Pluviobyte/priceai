...
export default function PrivacyPage() {
  return <main className="priceai-login-page"><section><h1>账户隐私说明</h1>
    ...
    <div className="priceai-privacy-copy"><p>使用 Google 或 GitHub 登录时，PriceAI 获取该平台的账户标识、显示名称和已验证的邮箱，用于识别登录身份与展示个人账户。</p>
      ...
      <p>本站使用 Google Analytics 了解页面访问、滚动和出站点击等使用情况，并使用 Microsoft Clarity 生成会话录制和热度图，以发现可用性问题。这些服务可能收集页面地址、交互事件、设备与浏览器信息及大致地区；Clarity 默认遮罩网页中的敏感内容。我们不会主动把你的登录邮箱、昵称或表单内容作为分析事件发送给这两项服务。数据由 Google 和 Microsoft 按各自隐私政策处理。</p>
