...
export default function MerchantFeedPage() {
  ...
  return <main><section className="form-shell"><div className="form-intro"><span className="section-kicker">Merchant direct feed</span><h1>商家 Feed 申请</h1><p>提交公开 JSON Feed 后，平台会先做 URL 安全检查、字段校验和限量试采，人工通过后才标记“商家直连数据”。</p></div>
