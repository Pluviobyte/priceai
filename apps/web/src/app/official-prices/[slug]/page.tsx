  ...
  return <div className="priceai-page priceai-official-detail-page">
    ...
    <main className="priceai-detail-shell">
      ...
      <section className="priceai-detail-hero">
        <div><span>官方订阅地区参考</span><h1>{planName}</h1><p>各币种按各自最新有效汇率折算，缺少有效汇率时保留历史换算及其日期；按显示的人民币金额由低到高排列，同币种、同原币金额且换算价相同时官网优先，缺少精确价格或换算的记录置后。周期待核验的内购金额不能直接当作标准月费；税费与购买资格以结算页为准。</p></div>
